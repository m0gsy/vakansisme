  ...
  return (
    <div className="min-h-screen bg-charcoal">
      <div className="max-w-7xl mx-auto px-6" style={{ paddingTop: "32px", paddingBottom: "80px" }}>
        <h1 className="font-display font-black uppercase text-off-white" style={{ fontSize: "clamp(1.5rem, 4vw, 2.2rem)", letterSpacing: "-0.025em", lineHeight: 0.9, marginBottom: "8px" }}>
          PAYMENTS
        </h1>
